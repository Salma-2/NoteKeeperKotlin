...
class DataManagerTest {
    ...
    fun findSimilarNotes(){
        ...
        val noteText2 = " This is the body of my test note2"
        ...
        val foundNote1 = DataManager.notes.indexOf(note1)
        assertEquals(index1,foundNote1)

        val note2 =DataManager.findNote(course, noteTitle,noteText2)
        val foundNote2 = DataManager.notes.indexOf(note2)
        assertEquals(index2,foundNote2)
